...
2 & Basisaufbau: Display in Betrieb nehmen, Joystick und Taster
    anbinden, Software-Grundgerüst & 3 \\
...
\subsection{Anlage 1 – Schaltplan}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/schaltplan.png}
    \caption{Schaltplan der Arduino-PIXEL-Konsole}
\end{figure}
...
% ============================================================
\newpage
\subsection{Anlage 2 – Arduino PIXEL und Spiele}

\subsubsection*{Homescreen}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/homescreen.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/game_selection.jpg}
    \caption{Implementierung der Spieleauswahl}
\end{figure}
...
% ============================================================
\newpage
\subsection{Anlage 3 – Interessante Code-Stellen}
...
\subsubsection*{Programm Loop}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/loop.png}
    \caption{Übergeordneter Programm Loop}
\end{figure}
\end{document}
